...
<body>
  ...
  <section class="home-section">
    ...
    <button type="button" class="btn btn-success p-2" onclick="window.location.href='newAddStudent.php';">ADD Student</button>
   </div>

  <div class="col-auto" style="margin-right:5px;">
    <button type="button" class="btn btn-primary p-2" onclick="window.location.href='newUpdateStudent.php';">EDIT Student</button>
  </div>

  <div class="col-auto" style="margin-right:5px;">
    <button type="button" class="btn btn-danger p-2" onclick="window.location.href='newDeleteStudent.php';">DROP Student</button>
</div>
