...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "DELETE FROM  courses WHERE courseID = '$delID'";
            ...
            DELETE COURSES
                ...
                <form method="POST" id="newDropForm">
                    ...
                    <div class="input-group input-group-sm mb-3" style="width: 300px;">
                        ...
                        <input type="text" class="form-control border border-danger" name="delID" placeholder="Enter ID" required>
                    </div>

                    <div class="col-auto">
                        <button type="submit" class="btn btn-danger p-2" style="margin-right:10px;">DELETE COURSE</button>
    ...
    <script>
        ...
        rows.forEach(row => {
            row.addEventListener('click', function() {
                ...
                document.querySelector('input[name="delID"]').value = courseID;
            });
        });
    </script>
