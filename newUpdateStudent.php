...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($result->num_rows > 0) {
            ...
            username='$newUsername', firstName='$newFirstName', lastName='$newLastName', contactNumber='$newContactNumber', studentAddress='$newAddress', passcode='$newPassword', userType = 'student' 
            WHERE studentID = $updateID";  
                ...
                <form method="POST" action="" id="newUpdateForm">
                    <div style="width:800px;">
                        <div class="input-group input-group-sm mb-3" style="width:250px;">
                            ...
                            <input type="text" class="form-control border border-black" name="updateID" placeholder=" Student ID"  readonly>
                        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($results as $result) :?>
                                <tr class="student-row" data-id="<?=htmlentities($result->studentID); ?>" 
                                    ...
                                    data-address="<?=htmlentities($result->studentAddress); ?>" 
    ...
    <script>
        ...
        rows.forEach(row => {
            row.addEventListener('click', function() {
                ...
                document.querySelector('input[name="updateID"]').value = studentID;
